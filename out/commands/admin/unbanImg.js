        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        if (member) {
                            role = adminUtil_1.getRole(message, "629774109655695370");
                            if (!role)
                                return [2 /*return*/, console.log("could not find role jail")
                                    //NOTE Remove role
                                ];
                            //NOTE Remove role
                            member.removeRole(role);
                            //NOTE Send embed
                            adminUtil_1.adminEmbed(message, member, "Allow Image Posting", args.join(" "));
                        }
                        else {
