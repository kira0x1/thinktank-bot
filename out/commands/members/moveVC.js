...
exports.command = {
    ...
    args: true,
    usage: "[ChannelID | Alias] [ChannelID | Alias]`\n\n" + channelAliases.map(function (ch) { return "**" + ch.name + ":** [`" + ch.aliases.join("`, `") + "`]\n"; }),
    perms: ["admin"],
    execute: function (message, args) {
        return __awaiter(this, void 0, void 0, function () {
            var fromQuery, toQuery, fromChannel, toChannel, channelFound, channelFound;
            var _this = this;
            return __generator(this, function (_a) {
                ...
                if (!fromChannel) {
                    channelFound = channelAliases.find(function (ch) { return ch.aliases.includes(fromQuery.toLowerCase()); });
                    if (channelFound) {
                        fromChannel = message.guild.channels.get(channelFound.id);
                    }
                }
                if (!toChannel) {
                    channelFound = channelAliases.find(function (ch) { return ch.aliases.includes(toQuery.toLowerCase()); });
                    if (channelFound) {
                ...
                fromChannel.members.map(function (member) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        if (toChannel) {
