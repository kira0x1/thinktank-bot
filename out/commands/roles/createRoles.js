    ...
    execute: function (message, args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        guild = message.client.guilds.get(config_1.guild_id);
                        if (!guild)
                            return [2 /*return*/];
                        rolesChannel = guild.channels.get("628565019508080660");
                        if (!rolesChannel)
                            return [2 /*return*/];
                        games = customRoles.sections.find(function (cr) { return cr.title === "Watching"; });
                        roles = games.roles;
                        titleEmbed = new discord_js_1.RichEmbed();
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(i < roles.length)) return [3 /*break*/, 5];
                        role = roles[i];
                        if (!(msg instanceof discord_js_1.Message)) return [3 /*break*/, 4];
                        return [4 /*yield*/, msg.react(role.emoji)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
